...
### Enemy Health Bars
* Renders health bars above active enemies.
* Includes line-of-sight checks and distance fading.
...
* Displays animated damage numbers in 3D space when hitting enemies.
